...
ksemilla_azar  <- 300017   #cambiar por la primer semilla
...
setwd( "d:/archi/ernesto/mmd/Aplicaciones_a_Economia_y_Finanzas" )
...
setwd("d:/archi/ernesto/mmd/Aplicaciones_a_Economia_y_Finanzas/labo/exp/HT3210/")   #Establezco el Working Directory DEL EXPERIMENTO
