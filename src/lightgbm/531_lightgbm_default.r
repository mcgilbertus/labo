...
ksemilla_azar  <- 300017  #Aqui poner la propia semilla
...
setwd("d:\\archi\\ernesto\\mmd\\Aplicaciones_a_Economia_y_Finanzas\\labo\\exp\\HT5310\\")   #Establezco el Working Directory DEL EXPERIMENTO
